...
- 🎓 MCA student at CHRIST University, Bangalore (BCA grad, CGPA 9.52/10)
- 📈 Focused on **Data Analysis, ML & Cloud-based systems**
- ☁️ AWS Cloud certified — comfortable with S3, IAM, and cloud architecture
- 🔬 Currently exploring **RAG applications** and AI content forensics
- 💡 Love turning messy datasets into clean, stakeholder-ready insights
...
|---|---|---|
| **[Procto](https://github.com/eersay/Procto)** | AI-powered exam proctoring platform | React, Express, PostgreSQL, Docker |
| **[Silver Analytics Dashboard](https://github.com/Bhagyasreeroy/Silver-Analytics-Dashboard)** | Geospatial commodity price analysis across India | Python, Plotly/Dash, GeoPandas |
| **[Shopping Behaviour Analysis](https://github.com/Bhagyasreeroy/shopping-behaviour)** | Customer segmentation & EDA | Python, Pandas, Scikit-learn |
| **[HEAL](https://github.com/neha-n-git/HEAL)** | Mental health support platform | HTML, CSS, JS, PHP |
| **[Christite](https://github.com/eersay/Christite)** | University mobile app with live notifications | React Native, Appwrite |
